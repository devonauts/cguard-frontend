    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="notification-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="notification-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="notification-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="notification-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=notification">
