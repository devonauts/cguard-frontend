...
function IncidentListTable(props) {
  const [
    recordIdToDestroy,
            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'title'}
                  label={i18n(
                    'entities.incident.fields.title',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'description'}
                  label={i18n(
                    'entities.incident.fields.description',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.incident.fields.imageUrl',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'wasRead'}
                  label={i18n(
                    'entities.incident.fields.wasRead',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.incident.fields.stationIncidents',
                  )}
                />
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    <StationListItem value={row.stationIncidents} />
                  </td>
