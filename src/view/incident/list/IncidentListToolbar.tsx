...
function IncidentToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    incidentSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    incidentSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="incident-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="incident-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="incident-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="incident-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=incident">
