...
const schema = yup.object().shape({
  tutorialName: yupFormSchemas.string(
    i18n('entities.tutorial.fields.tutorialName'),
    {
      "max": 200
    },
  ),
  tutorialCategory: yupFormSchemas.relationToOne(
    i18n('entities.tutorial.fields.tutorialCategory'),
    {},
  ),
  tutorialVideos: yupFormSchemas.relationToMany(
...
function TutorialForm(props) {
  const [initialValues] = useState(() => {
    ...
    return {
      tutorialName: record.tutorialName,
      tutorialCategory: record.tutorialCategory,
      tutorialVideos: record.tutorialVideos || [],
    };
  });
