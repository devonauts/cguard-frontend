          ...
          <thead className="thead">
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.service.fields.iconImage',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.service.fields.serviceImages',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'specifications'}
                  label={i18n(
                    'entities.service.fields.specifications',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'subtitle'}
                  label={i18n(
                    'entities.service.fields.subtitle',
                  )}
                />
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    <ImagesListView value={row.iconImage} />
                  </td>
                  <td>{row.title}</td>
                  ...
                  <td>
                    <ImagesListView value={row.serviceImages} />
                  </td>
