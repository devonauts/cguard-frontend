...
const schema = yup.object().shape({
  dateTimeRange: yupFilterSchemas.datetimeRange(
    i18n('entities.memos.fields.dateTimeRange'),
  ),
  ...
  wasAccepted: yupFilterSchemas.boolean(
...
const previewRenders = {
  dateTimeRange: {
    label: i18n('entities.memos.fields.dateTimeRange'),
...
function MemosListFilter(props) {
...
export default MemosListFilter;