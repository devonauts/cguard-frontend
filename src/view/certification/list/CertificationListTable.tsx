...
function CertificationListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    certificationSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'title'}
                  label={i18n(
                    'entities.certification.fields.title',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'code'}
                  label={i18n(
                    'entities.certification.fields.code',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.certification.fields.image',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.certification.fields.icon',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'description'}
                  label={i18n(
                    'entities.certification.fields.description',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  label={i18n(
                    'entities.certification.fields.acquisitionDate',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'expirationDate'}
                  label={i18n(
                    'entities.certification.fields.expirationDate',
                  )}
                />
