...
function PatrolToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    patrolSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    patrolSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="patrol-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="patrol-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="patrol-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="patrol-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=patrol">
