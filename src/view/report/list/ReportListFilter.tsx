...
import actions from 'src/modules/report/list/reportListActions';
...
const schema = yup.object().shape({
  ...
  generatedDateRange: yupFilterSchemas.datetimeRange(
    i18n('entities.report.fields.generatedDateRange'),
  ),
...
const previewRenders = {
  ...
  generatedDateRange: {
    label: i18n('entities.report.fields.generatedDateRange'),
...
function ReportListFilter(props) {
