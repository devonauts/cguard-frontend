...
function PatrolLogToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    patrolLogSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    patrolLogSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="patrol-log-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="patrol-log-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="patrol-log-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="patrol-log-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=patrolLog">
...
export default PatrolLogToolbar;
