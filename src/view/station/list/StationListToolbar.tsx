...
function StationToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    stationSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    stationSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="station-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="station-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="station-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="station-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=station">
