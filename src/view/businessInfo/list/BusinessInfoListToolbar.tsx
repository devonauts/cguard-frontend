...
function BusinessInfoToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    businessInfoSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    businessInfoSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="business-info-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="business-info-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="business-info-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="business-info-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/business-info/importer">
          <button className="btn btn-primary" type="button">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=businessInfo">
...
export default BusinessInfoToolbar;
