...
function BusinessInfoListTable(props) {
  const [
    recordIdToDestroy,
            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'companyName'}
                  label={i18n(
                    'entities.businessInfo.fields.companyName',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'description'}
                  label={i18n(
                    'entities.businessInfo.fields.description',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'contactPhone'}
                  label={i18n(
                    'entities.businessInfo.fields.contactPhone',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'contactEmail'}
                  label={i18n(
                    'entities.businessInfo.fields.contactEmail',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'address'}
                  label={i18n(
                    'entities.businessInfo.fields.address',
                  )}
                />
...
export default BusinessInfoListTable;
