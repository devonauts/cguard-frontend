...
function InquiriesToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    inquiriesSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    inquiriesSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="inquiries-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="inquiries-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="inquiries-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="inquiries-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=inquiries">
...
export default InquiriesToolbar;
