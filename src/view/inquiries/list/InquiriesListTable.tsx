...
function InquiriesListTable(props) {
  const [
    recordIdToDestroy,
            ...
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  ...
                  name={'names'}
                  label={i18n(
                    'entities.inquiries.fields.names',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'city'}
                  label={i18n(
                    'entities.inquiries.fields.city',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'email'}
                  label={i18n(
                    'entities.inquiries.fields.email',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'phoneNumber'}
                  label={i18n(
                    'entities.inquiries.fields.phoneNumber',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'message'}
                  label={i18n(
                    'entities.inquiries.fields.message',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.inquiries.fields.serviceOfInterest',
                  )}
                />
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>{row.message}</td>
                  <td>
                    <ServiceListItem value={row.serviceOfInterest} />
                  </td>
