...
function RequestToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    requestSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    requestSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="request-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="request-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="request-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="request-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
