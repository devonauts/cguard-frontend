...
function InventoryToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    inventorySelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    inventorySelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="inventory-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="inventory-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tooltip-id="inventory-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="inventory-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=inventory">
