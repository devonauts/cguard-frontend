...
import shiftSelectors from 'src/modules/shift/shiftSelectors';
import destroyActions from 'src/modules/shift/destroy/shiftDestroyActions';
import destroySelectors from 'src/modules/shift/destroy/shiftDestroySelectors';
...
function ShiftListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    shiftSelectors.selectPermissionToEdit,
  );
  const hasPermissionToDestroy = useSelector(
    shiftSelectors.selectPermissionToDestroy,
  );
          ...
          <thead className="thead">
            <tr>
              <TableColumnHeader className="th-checkbox">
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.shift.fields.station',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.shift.fields.guard',
                  )}
                />
